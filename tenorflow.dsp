...
damp = hslider("/v:2/h:reverb/h:reverb1/[1]damp[style:knob]", 0.5, 0, 1, 0.1);
...
process = wave + selectedBreath * breathVolume <: formantFilterbank :> fi.lowpass(2, freq * 5) * gain * envelop * gate * t;
